...
f_svm = open("./out/010svm_9.txt", 'w')  ###################################################
f_LogisticR = open("./out/010LogisticR_9.txt", 'w')  ###################################################
f_RandomF = open('./out/010RandomF_9.txt', 'w')  ###################################################
f_xgboost = open('./out/010xgboost_9.txt', 'w')  ###################################################)
f_lightGBM = open('./out/010lightGBM_9.txt', 'w')  ###################################################)
