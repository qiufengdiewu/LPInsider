...
model.wv.save_word2vec_format("./out/03722Word2vec_word2vec_format_model",binary=True)##############
#read
model = gensim.models.KeyedVectors.load_word2vec_format("./out/03722Word2vec_word2vec_format_model",binary=True)###############
print("first")
print(model)
print(model["H19"])
words_all = []
...
model.wv.save_word2vec_format("./out/03722Word2vec_word2vec_format_model",binary=True)#############
model_temp.intersect_word2vec_format("./out/021Word2vec_word2vec_format_model",binary=True,lockf=0.0)###############
#model.intersect_word2vec_format("./out/021Word2vec_word2vec_format_model",binary=True,lockf=1.0)
print("final")
print(model_temp["H19"])
model_temp.save("./out/03722Word2vec_word2vec_format_model")##############
#read
model = gensim.models.word2vec.Word2Vec.load("./out/03722Word2vec_word2vec_format_model")#############
...
model.save("./out/03722Word2vec_word2vec_format_model")###############
print("success")
print(model["H19"])
