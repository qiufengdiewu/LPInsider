...
f_svm = open("./out/010svm_10_average_preprocess.txt", 'w')  ###################################################
f_LogisticR = open("./out/010LogisticR_10_average_preprocess.txt", 'w')  ###################################################
f_RandomF = open('./out/010RandomF_10_average_preprocess.txt', 'w')  ###################################################
f_xgboost = open('./out/010xgboost_10_average_preprocess.txt', 'w')  ###################################################)
f_lightGBM = open('./out/010lightGBM_10_average_preprocess.txt', 'w')  ###################################################)
