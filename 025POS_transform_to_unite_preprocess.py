...
sample_POS=pd.read_csv("./in/023sample_word_transform_to_POS_preprocess.txt",sep='\t',header=None)
f=open("./in/025POS_transform_to_unite_preprocess.txt","w",encoding="utf-8")
