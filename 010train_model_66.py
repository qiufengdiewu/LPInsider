...
f_svm = open("./out/010svm_666.txt", 'w')  ###################################################
f_LogisticR = open("./out/010LogisticR_666.txt", 'w')  ###################################################
f_RandomF = open('./out/010RandomF_666.txt', 'w')  ###################################################
f_xgboost = open('./out/010xgboost_666.txt', 'w')  ###################################################)
f_lightGBM = open('./out/010lightGBM_666.txt', 'w')  ###################################################)
